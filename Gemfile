...
# background jobs
gem 'sidekiq', '~> 7.0.8' # sidekiq 7 and redis 5 do not work properly https://stackoverflow.com/questions/74314906/heartbeat-unsupported-command-argument-type-falseclass-redis
