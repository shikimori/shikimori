...
// ========================= Masonry ===============================
  ...
  $.Mason.prototype._reLayout = function( callback ) {
    ...
    if ( this.options.cornerStampSelector ) {
      ...
      var cornerStampBottom = $cornerStamp.offset().top + $cornerStamp.outerHeight(true);
    }
    // reset columns
    var i = this.cols;
    this.colYs = [];
    ...
    // set correct height to mason container
    if ( this.options.cornerStampSelector ) {
      var lastBrick = this.$bricks.last();
      var lastBrickTop = parseInt(lastBrick.css('top'));
      if (lastBrickTop < cornerStampBottom) {
        this.element.css('height', lastBrickTop  + lastBrick.height() + 'px');
      }
    }
  };
})( window, jQuery );
