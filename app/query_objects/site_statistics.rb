class SiteStatistics
  ...
  ACHIEVEMENT_USER_IDS = [3824, 210, 16398, 34807, 29386, 84020, 72620, 50587, 100600, 77362, 249685, 59888, 7642, 204, 37763, 100971, 31022, 111580, 12671, 169737, 131808, 2727, 29326, 883] # rubocop:disable all
