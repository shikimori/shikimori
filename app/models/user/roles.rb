class User
  module Roles
    ...
    TRUSTED_VIDEO_UPLOADERS = (ADMINS + VIDEO_MODERATORS + [16750, 16774, 10026, 20455, 10026, 12023, 8237, 17423, 11834, 21347, 4792, 10342, 20483, 16858, 34724, 28601, 24518, 5019, 40713, 16178, 17532, 33635, 44418, 15511, 17916, 30214]).uniq
