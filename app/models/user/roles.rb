class User
  module Roles
    ...
    Moderators = (Admins + [921, 11, 188, 861, 93]).uniq # 2 - Adelor, 2033 - zmej1987, 861 - Oniii-chan, 93 - lena-chan
    ...
    # 20483 - Крипке, 16858 - ✿Yuki Yu✿
    TrustedVideoUploaders = (Admins + [11496, 4099, 12771, 13893, 11883, 5064, 5779, 14633, 5255, 7028, 15905, 3954, 16750, 16774, 10026, 20455, 10026, 12023, 8237, 17423, 11834, 21347, 4792, 10342, 7028, 20483, 16858]).uniq
