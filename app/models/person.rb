class Person < DbEntry
  ...
  has_one :poster, -> { active }, inverse_of: :person # rubocop:disable Rails/HasManyOrHasOneDependent
  ...
  attribute :birth_on, IncompleteDate
  attribute :deceased_on, IncompleteDate
