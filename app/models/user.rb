...
class User < ActiveRecord::Base
  ...
  TrustedVideoUploaders = (Admins + [11496, 4099, 12771, 13893, 11883, 5064]).uniq # 11496 - АлхимиК, 4099 - sttany, 12771 - spinosa, 13893 - const, 11883 - Tenno Haruka, 5064 - Heretic
