class SitemapController < ApplicationController
  def index
    ...
    @anime_sections = [
      ...
      ['Аниме лета 2012 года', animes_url(season: 'summer_2012')],
      ['Аниме весны 2012 года', animes_url(season: 'spring_2012')],
      ['Аниме зимы 2012 года', animes_url(season: 'winter_2012')],
