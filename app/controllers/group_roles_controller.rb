class GroupRolesController < ShikimoriController
  ...
  def create
    ...
    redirect_to club_url(@resource.group), notice: "Вы вступили в #{@resource.group.name}"
  end
  ...
  def destroy
    ...
    redirect_to club_url(@resource.group), notice: "Вы покинули #{@resource.group.name}"
  end
