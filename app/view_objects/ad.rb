...
private
  ...
  SPECIAL_X300 = {
    provider: Types::Ad::Provider[:special],
    # AD START: MANGA - remove 2022-06-19 23:59
  ...
  META_TYPES = {
    true => {
      ...
      Types::Ad::Meta[:menu_240x400] => [
        # Types::Ad::Type[:special_x300], # MANGA - remove 2022-06-19 23:59
        Types::Ad::Type[:yd_240x600],
        Types::Ad::Type[:mt_240x400]
      ],
      Types::Ad::Meta[:menu_300x600] => [
      ...
      Types::Ad::Meta[:special_x1170] => [
        # Types::Ad::Type[:special_x1170], # MANGA - remove 2022-06-19 23:59
        Types::Ad::Type[:yd_970x250],
        Types::Ad::Type[:mt_970x250]
      ]
    },
