...
private
  ...
  SPECIAL_X300 = {
    ...
    #   }
    # end,
    url: 'https://лето.будьвдвижении.рф/?utm_source=site&utm_medium=banner&utm_campaign=anime&utm_content=right&erid=',
    images: [{
  ...
  SPECIAL_X1170 = {
    ...
    # pixel: 'https://ads.adfox.ru/707246/getCode?p1=cxdxi&p2=frfe&pfc=exzsj&pfb=nqxpb&pr=[RANDOM]&ptrc=b',
    # convert -resize 50% app/assets/images/globals/events/2022-06-18/menu_1@2x.jpg app/assets/images/globals/events/2022-06-18/menu_1.jpg
    url: 'https://лето.будьвдвижении.рф/?utm_source=site&utm_medium=banner&utm_campaign=anime&utm_content=main&erid=',
    images: (1..1).map do |i|
      {
