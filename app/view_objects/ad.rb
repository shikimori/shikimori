...
private
  ...
  SPECIAL_X1170 = {
    ...
    images: (1..1).map do |i|
      {
        src: "/assets/globals/events/2022-10-05/wide_#{i}.jpg?v=4",
        src_2x: "/assets/globals/events/2022-10-05/wide_#{i}@2x.jpg?v=4"
      }
    end,
    # AD END
    # html: (
  ...
  META_TYPES = {
    true => {
      ...
      Types::Ad::Meta[:menu_240x400] => [
        Types::Ad::Type[:special_x300], # HZ - remove 2022-10-19 23:59
        Types::Ad::Type[:yd_240x600],
        Types::Ad::Type[:mt_240x400]
      ],
      Types::Ad::Meta[:menu_300x600] => [
      ...
      Types::Ad::Meta[:special_x1170] => [
        Types::Ad::Type[:special_x1170], # HZ - remove 2022-10-19 23:59
        Types::Ad::Type[:yd_970x250],
        Types::Ad::Type[:mt_970x250]
      ]
    },
