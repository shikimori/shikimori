...
ActiveRecord::Schema.define(:version => 20140129182415) do
  ...
  add_index "abuse_requests", ["comment_id", "kind", "value"], :name => "index_abuse_requests_on_comment_id_and_kind_and_value", :unique => true
  ...
  add_index "anime_calendars", ["anime_id", "episode"], :name => "index_anime_calendars_on_anime_id_and_episode", :unique => true
  ...
  add_index "anime_videos", ["anime_video_author_id"], :name => "index_anime_videos_on_anime_video_author_id"
  ...
  add_index "animes", ["kind"], :name => "index_animes_on_kind"
  ...
  add_index "animes_genres", ["anime_id"], :name => "index_animes_genres_on_anime_id"
  ...
  add_index "animes_studios", ["anime_id"], :name => "index_animes_studios_on_anime_id"
  ...
  add_index "bans", ["abuse_request_id"], :name => "index_bans_on_abuse_request_id"
  add_index "bans", ["comment_id"], :name => "index_bans_on_comment_id"
  add_index "bans", ["moderator_id"], :name => "index_bans_on_moderator_id"
  ...
  add_index "blob_datas", ["key"], :name => "index_blob_datas_on_key", :unique => true
  ...
  add_index "characters", ["japanese"], :name => "index_characters_on_japanese"
  add_index "characters", ["name"], :name => "index_characters_on_name"
  add_index "characters", ["russian"], :name => "index_characters_on_russian", :length => {"russian"=>50}
  ...
  add_index "comment_views", ["comment_id"], :name => "index_comment_views_on_comment_id"
  add_index "comment_views", ["user_id", "comment_id"], :name => "index_comment_views_on_user_id_and_comment_id", :unique => true
  ...
  add_index "cosplay_galleries", ["cos_rain_id"], :name => "index_cosplay_galleries_on_cos_rain_id", :unique => true
  ...
  add_index "cosplay_gallery_links", ["linked_id", "linked_type", "cosplay_gallery_id"], :name => "index_cosplay_gallery_links_on_l_id_and_l_type_and_cg_id", :unique => true
  ...
  add_index "cosplay_images", ["url"], :name => "index_cosplay_images_on_url"
  ...
  add_index "cosplayers", ["name"], :name => "index_cosplayers_on_name", :unique => true
  ...
  add_index "danbooru_tags", ["name", "kind"], :name => "index_danbooru_tags_on_name_and_kind"

  create_table "dc_bot_messages", :force => true do |t|
    t.text     "text"
    t.boolean  "processed",  :default => false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "entries", ["generated", "type", "created_at"], :name => "index_entries_on_in_forum_and_type_and_created_at"
  add_index "entries", ["type", "comments_count", "updated_at"], :name => "i_entries_type_comments_count_updated_at"
  add_index "entries", ["type", "linked_id", "linked_type"], :name => "i_entries_type_linked_type_linked_id"
  add_index "entries", ["type", "updated_at"], :name => "index_entries_on_type_and_updated_at"
  ...
  add_index "entry_views", ["entry_id"], :name => "index_entry_views_on_entry_id"
  add_index "entry_views", ["user_id", "entry_id"], :name => "index_entry_views_on_user_id_and_entry_id", :unique => true
  ...
  add_index "genres_mangas", ["manga_id"], :name => "index_genres_mangas_on_manga_id"
  ...
  add_index "group_invites", ["group_id", "dst_id", "status"], :name => "uniq_group_invites", :unique => true
  ...
  add_index "group_roles", ["user_id", "group_id"], :name => "uniq_user_in_group", :unique => true
  ...
  add_index "mangas", ["kind"], :name => "index_mangas_on_kind"
  ...
  add_index "person_roles", ["anime_id"], :name => "index_person_roles_on_anime_id"
  add_index "person_roles", ["character_id"], :name => "index_person_roles_on_character_id"
  add_index "person_roles", ["manga_id"], :name => "index_person_roles_on_manga_id"
  ...
  add_index "review_views", ["user_id", "review_id"], :name => "index_review_views_on_user_id_and_review_id", :unique => true
  ...
  add_index "reviews", ["target_id", "target_type"], :name => "index_reviews_on_target_id_and_target_type"
  ...
  add_index "screenshots", ["anime_id", "url"], :name => "index_screenshots_on_anime_id_and_url", :unique => true
  add_index "screenshots", ["anime_id"], :name => "index_screenshots_on_anime_id"
  add_index "screenshots", ["status"], :name => "index_screenshots_on_status"
  ...
  add_index "similar_animes", ["src_id"], :name => "index_similar_animes_on_src_id"
  ...
  add_index "similar_mangas", ["src_id"], :name => "index_similar_mangas_on_src_id"
  ...
  add_index "subscriptions", ["user_id", "target_type"], :name => "index_subscriptions_on_user_id_and_target_type"
  ...
  add_index "user_changes", ["status"], :name => "index_user_changes_on_status"
  ...
  add_index "user_histories", ["updated_at"], :name => "index_user_histories_on_updated_at"
  ...
  add_index "user_images", ["linked_id", "linked_type"], :name => "index_user_images_on_linked_id_and_linked_type"
  ...
  add_index "user_rates", ["user_id", "target_id", "target_type"], :name => "index_user_rates_on_user_id_and_target_id_and_target_type", :unique => true
  ...
  add_index "videos", ["anime_id"], :name => "index_videos_on_anime_id"
