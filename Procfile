...
camo: CAMO_KEY=abc PORT=5566 CAMO_ENDPOINT_PATH=/ CAMO_SOCKET_TIMEOUT=90 CAMO_LENGTH_LIMIT=20971520 CAMO_LOGGING_ENABLED=debug CAMO_ALLOWED_HOSTS=safebooru.org,danbooru.donmai.us,hijiribe.donmai.us,yande.re,files.yande.re,konachan.com coffee ../camo/server.coffee
