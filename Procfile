...
faye: cd ../faye-server && NODE_ENV=development FAYE_PORT=9292 FAYE_KEY=11111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111 FAYE_ENDPOINT_PATH=/faye-server-v4 node server.js
