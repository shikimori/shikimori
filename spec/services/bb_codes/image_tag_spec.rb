describe BbCodes::ImageTag do
  ...
  describe '#format' do
    ...
    context 'common case' do
      it { is_expected.to eq "<a href=\"#{user_image.image.url :original}\" rel=\"#{text_hash}\" class=\"b-image unprocessed\">\
...
<span class=\"marker\">1000x1000</span></a>" }
    ...
    context 'small image' do
      ...
      it { is_expected.to eq "<img src=\"#{user_image.image.url :original}\" \
data-width=\"#{user_image.width}\" data-height=\"#{user_image.height}\" />" }
    end
