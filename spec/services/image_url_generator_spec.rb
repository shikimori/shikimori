        ...
        context 'original' do
          ...
          it do
            is_expected.to eq(
              ...
              "#{protocol}://nyaa.#{domain}/system/animes/original/1.jpg?#{timestamp}"
            )
          end
        end
        ...
        context 'x48' do
          ...
          it do
            is_expected.to eq(
              ...
              "#{protocol}://nyaa.#{domain}/system/animes/x48/1.jpg?#{timestamp}"
            )
          end
        end
      end
      ...
      context 'club' do
        ...
        it do
          is_expected.to eq(
            ...
            "#{protocol}://nyaa.#{domain}/system/clubs/x96/2.jpg?#{timestamp}"
          )
        end
      end
      ...
      context 'user' do
        ...
        it do
          is_expected.to eq(
            ...
            "#{protocol}://nyaa.#{domain}/system/users/x160/2.png?#{timestamp}"
          )
        end
      end
      ...
      context 'decorated user' do
        ...
        it do
          is_expected.to eq(
            ...
            "#{protocol}://nyaa.#{domain}/system/users/x48/3.png?#{timestamp}"
          )
        end
      end
    end
