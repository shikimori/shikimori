  ...
  describe '#extract' do
   ...
   context 'frame' do
    ...
    describe 'vk_1' do
      ...
      it { is_expected.to eq 'http://vk.com/video_ext.php?oid=-31193397&id=165152640&hash=924605cf891257c2' }
    end
    ...
    describe 'vk_2' do
      ...
      it { is_expected.to eq 'http://vkontakte.ru/video_ext.php?oid=154832837&id=161773398&hash=3c74648f3d5c6cfc' }
    end
    ...
    describe 'vk_3' do
      ...
      it { is_expected.to eq 'http://vk.com/video_ext.php?oid=31645372&id=163523215&hash=3fba843aaeb2a8ae' }
    end
    ...
    describe 'myvi_1' do
      ...
      it { is_expected.to eq 'http://myvi.tv/embed/html/oIxbMgoWkVjUm-HHtYw1d1Gwj5xxyVdusrAmuarGU8ycjTIaeOcNlgGbGEZGhTGLE0' }
    end
    ...
    describe 'myvi_2' do
      ...
      it { is_expected.to eq 'http://myvi.tv/embed/html/oCJCcZPAwDviOuI-cOd-JrhfCmNXN_Z8j1E4-AfyYvpDRsgS_SwGRg2SBXhTpEZs30' }
    end
    ...
    describe 'myvi_3' do
      ...
      it { is_expected.to eq 'http://myvi.tv/embed/html/oeBRkeha50wjXJIEU75wbYvUhlv4siaYE0KFla8kRgTHedQxAysFOs2B_yAWy3Tu80' }
    end
    ...
    describe 'myvi_4' do
      ...
      it { is_expected.to eq 'http://myvi.tv/embed/html/o-yLxiEDfwHkdkERps0Ol8xsewC-jd-DQ-g5RR1EkMf2kwIfTBIScHSFJW4DvGJOu0hk' }
    end
    ...
    describe 'myvi_5' do
      ...
      it { is_expected.to eq 'http://myvi.tv/embed/html/oiLWME7qo9O3ragh7JC_fq2nr-f51DLt98_60sos3gbiY1ufb4hPA30whqpGE8VVjlVMzhdCsZgM1' }
    end

    describe 'myvi_6' do
      let(:html) { 'http://myvi.tv/embed/html/o2uWMvJRKqAyXG2EJUGGwUUKZwjleODmTYy0zGlks1-J5IO6Aexc_mKSgpudtZ7Zn0' }
      it { is_expected.to eq 'http://myvi.tv/embed/html/o2uWMvJRKqAyXG2EJUGGwUUKZwjleODmTYy0zGlks1-J5IO6Aexc_mKSgpudtZ7Zn0' }
    end
    ...
    describe 'myvi_7' do
      ...
      it { is_expected.to eq 'http://myvi.tv/embed/html/ooS23CgoxYNdHcm9FqwDb664Lbqhd1v7gyl7jDKc3O1xQ3-g0VOYjzoru3F35w6Ia0' }
    end
    ...
    describe 'mail_ru_1' do
      ...
      it { is_expected.to eq 'http://api.video.mail.ru/videos/embed/mail/bel_comp1/14985/16397.html' }
    end
    ...
    describe 'mail_ru_2' do
      ...
      it { is_expected.to eq 'http://api.video.mail.ru/videos/embed/mail/bel_comp1/14985/15939.html' }
    end
    ...
    describe 'mail_ru_3' do
      ...
      it { is_expected.to eq 'http://img.mail.ru/r/video2/player_v2.swf?par=http://video.mail.ru/mail/ol4ik87.87/1123/$3816' }
    end
    ...
    describe 'mail_ru_4' do
      ...
      it { is_expected.to eq 'https://videoapi.my.mail.ru/videos/embed/mail/allenwolker91/11052/11071.html' }
    end
    ...
    describe 'rutube_1' do
      ...
      it { is_expected.to eq 'http://rutube.ru/video/embed/6504640' }
    end
    ...
    describe 'rutube_2' do
      ...
      it { is_expected.to eq 'http://video.rutube.ru/28c276bcec9a0619affa8e2443551b32' }
    end
    ...
    describe 'rutube_3' do
      ...
      it { is_expected.to eq 'http://rutube.ru/embed/6127963' }
    end
    ...
    describe 'rutube_4' do
      ...
      it { is_expected.to eq 'http://rutube.ru/video/embed/6661157' }
    end

    describe 'rutube_5' do
      let(:html) { 'http://rutube.ru/tracks/2300012.html?v=8c8bbdc632726555649d45c2c6a273c0' }
      it { is_expected.to eq 'http://video.rutube.ru/8c8bbdc632726555649d45c2c6a273c0' }
    end
    ...
    describe 'rutube_6' do
      ...
      it { is_expected.to eq 'http://rutube.ru/play/embed/7300160' }
    end
    ...
    describe 'sibnet_1' do
      ...
      it { is_expected.to eq 'http://video.sibnet.ru/shell.php?videoid=1186077' }
    end

    describe 'sibnet_2' do
      let(:html) { "http://data10.video.sibnet.ru/13/88/40/1388407.flv" }
      it { is_expected.to eq 'http://video.sibnet.ru/shell.php?videoid=1388407' }
    end
    ...
    describe 'sibnet_3' do
      ...
      it { is_expected.to eq 'http://video.sibnet.ru/shell.php?videoid=710879' }
    end

    describe 'sibnet_4' do
      let(:html) { "http://data9.video.sibnet.ru/12/24/22/1224221.mp4?st=FRf7r1A0LxkpPBmuFybKXA&e=1375711000" }
      it { is_expected.to eq 'http://video.sibnet.ru/shell.php?videoid=1224221' }
    end
    ...
    describe 'kiwi_1' do
      ...
      it { is_expected.to eq 'http://v.kiwi.kz/v2/s3jf896ex7h9/' }
    end
    ...
    describe 'kiwi_2' do
      ...
      it { is_expected.to eq 'http://p.kiwi.kz/static/player2/player.swf?config=http://p.kiwi.kz/static/player2/video.txt&url=http://farm.kiwi.kz/v/yvb2eb5r6y71/%3Fsecret%3DxrUpVyacqXt8unyeBzN4%2Bw%3D%3D&poster=http://im6.asset.kwimg.kz/screenshots/normal/yv/yvb2eb5r6y71_2.jpg&title=Mawaru+Penguin+Drum+-+23+%D1%81%D0%B5%D1%80%D0%B8%D1%8F+%28%D1%80%D1%83%D1%81.+%D1%81%D1%83%D0%B1%D1%82.+Ad...&redirect=http://kiwi.kz/watch/yvb2eb5r6y71/&page=http://kiwi.kz/watch/yvb2eb5r6y71/&embed=%3Ciframe+title%3D%22Kiwi+player%22+width%3D%22640%22+height%3D%22385%22+src%3D%22http%3A%2F%2Fv.kiwi.kz%2Fv2%2Fyvb2eb5r6y71%2F%22+frameborder%3D%220%22+allowfullscreen%3E%3C%2Fiframe%3E&related=http%3A%2F%2Fkiwi.kz%2Fapi%2Fmovies%2Frelated2%3Fhash%3Dyvb2eb5r6y71&like=http%3A%2F%2Fkiwi.kz%2Fwatch%2Fyvb2eb5r6y71%2Flike%2F&unlike=http%3A%2F%2Fkiwi.kz%2Fwatch%2Fyvb2eb5r6y71%2Funlike%2F&fave=http%3A%2F%2Fkiwi.kz%2Fwatch%2Fyvb2eb5r6y71%2Ffave%2F&unfave=http%3A%2F%2Fkiwi.kz%2Fwatch%2Fyvb2eb5r6y71%2Funfave%2F' }
    end
    ...
    describe 'youtube_1' do
      ...
      it { is_expected.to eq 'http://www.youtube.com/embed/pOSilkJpCUI?feature=player_detailpage' }
    end
    ...
    describe 'youtube_2' do
      ...
      it { is_expected.to eq 'http://www.youtube.com/v/CezgoEWr6U0?version=3&feature=player_detailpage' }
    end
    ...
    describe 'youtube_3' do
      ...
      it { is_expected.to eq 'http://www.youtube.com/embed/pmLm4phNjB4' }
    end
    ...
    describe 'video.yandex' do
      ...
      it { is_expected.to eq 'http://video.yandex.ru/iframe/dashaset08/pwq0ljt7p4.5028/' }
    end
    ...
    describe 'i.ua' do
      ...
      it { is_expected.to eq 'http://i.i.ua/video/evp.swf?V=504dd.ac6bb.59d.8e7cdf9.k29b27ead' }
    end
    ...
    describe 'flashx.tv' do
      ...
      it { is_expected.to eq 'http://www.flashx.tv/embed-g5yfee5j0acc.html' }
    end
    ...
    describe 'vidbull.com' do
      ...
      it { is_expected.to eq 'http://vidbull.com/embed-z8cyfxvok8nm-720x405.html' }
    end
    ...
    describe 'mipix.eu' do
      ...
      it { is_expected.to eq 'https://mipix.eu/translations/embed/274265' }
    end
    ...
    describe 'smotret-anime.ru' do
      ...
      it { is_expected.to eq 'https://smotret-anime.ru/translations/embed/522965' }
    end
