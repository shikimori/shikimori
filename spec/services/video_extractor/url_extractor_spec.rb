  ...
  describe 'extract' do
   ...
   context 'frame' do
    ...
    describe 'myvi_1' do
      ...
      it { should eq 'http://myvi.tv/embed/html/oIxbMgoWkVjUm-HHtYw1d1Gwj5xxyVdusrAmuarGU8ycjTIaeOcNlgGbGEZGhTGLE0' }
    end
    ...
    describe 'myvi_2' do
      ...
      it { should eq 'http://myvi.tv/embed/html/oCJCcZPAwDviOuI-cOd-JrhfCmNXN_Z8j1E4-AfyYvpDRsgS_SwGRg2SBXhTpEZs30' }
    end
    ...
    describe 'myvi_4' do
      ...
      it { should eq 'http://myvi.tv/embed/html/o-yLxiEDfwHkdkERps0Ol8xsewC-jd-DQ-g5RR1EkMf2kwIfTBIScHSFJW4DvGJOu0hk' }
    end
    ...
    describe 'myvi_5' do
      ...
      it { should eq 'http://myvi.tv/embed/html/oiLWME7qo9O3ragh7JC_fq2nr-f51DLt98_60sos3gbiY1ufb4hPA30whqpGE8VVjlVMzhdCsZgM1' }
    end
