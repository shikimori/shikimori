  ...
  describe '#fetch' do
    ...
    context 'valid_url' do
      context 'common case' do
        ...
        its(:image_url) { is_expected.to eq 'http://img.youtube.com/vi/VdwKZ6JDENc/mqdefault.jpg' }
        its(:player_url) { is_expected.to eq 'http://youtube.com/embed/VdwKZ6JDENc' }
      end
      ...
      context 'youtu.be' do
        ...
        its(:hosting) { is_expected.to eq :youtube }
        its(:image_url) { is_expected.to eq 'http://img.youtube.com/vi/n5qqfOXRRaA/mqdefault.jpg' }
        its(:player_url) { is_expected.to eq 'http://youtube.com/embed/n5qqfOXRRaA?start=3m3s' }
      end
      ...
      context 'with time' do
        ...
        its(:hosting) { is_expected.to eq :youtube }
        its(:image_url) { is_expected.to eq 'http://img.youtube.com/vi/VdwKZ6JDENc/mqdefault.jpg' }
        its(:player_url) { is_expected.to eq 'http://youtube.com/embed/VdwKZ6JDENc?start=123' }
      end
