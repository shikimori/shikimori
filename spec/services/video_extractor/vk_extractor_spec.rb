  ...
  describe '#fetch' do
    ...
    context 'valid_url' do
      context 'common' do
        ...
        its(:image_url) do
          is_expected.to eq(
            'https://sun9-24.userapi.com/c514511/u98023184/video/l_81cce630.jpg'
          )
        end
        its(:player_url) do
          is_expected.to eq(
            'https://vk.com/video_ext.php?oid=98023184&id=165811692&hash=6d9a4c5f93270892'
          )
        end
      end
      ...
      context 'common new' do
        ...
        its(:image_url) do
          is_expected.to eq(
            'https://sun9-42.userapi.com/c518307/u7644928/video/l_0320d336.jpg'
          )
        end
        its(:player_url) do
          is_expected.to eq(
            'https://vk.com/video_ext.php?oid=31645372&id=163523215&hash=3fba843aaeb2a8ae'
          )
        end
      end
