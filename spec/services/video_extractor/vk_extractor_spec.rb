  ...
  describe '#fetch' do
    ...
    context 'valid_url' do
      context 'common' do
        ...
        its(:image_url) { is_expected.to eq '//sun9-24.userapi.com/c514511/u98023184/video/l_81cce630.jpg' }
      ...
      context 'common new' do
        ...
        its(:hosting) { is_expected.to eq :vk }
        its(:image_url) { is_expected.to eq '//sun9-42.userapi.com/c518307/u7644928/video/l_0320d336.jpg' }
