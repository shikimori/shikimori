  ...
  describe 'pagination urls' do
    ...
    describe '#prev_page_url' do
      ...
      context 'second page' do
        let(:page) { 2 }
        it { is_expected.to eq "#{Shikimori::HOST}/animes/kind/tv" }
      end

      context 'third page' do
        let(:page) { 3 }
        it { is_expected.to eq "#{Shikimori::HOST}/animes/kind/tv/page/2" }
      end
    end
    ...
    describe '#next_page_url' do
      ...
      context 'first page' do
        let(:page) { 1 }
        it do
          is_expected.to eq "#{Shikimori::HOST}/animes/kind/tv/page/2"
        end
      end
