describe CalendarsQuery do
  ...
  let!(:anime2) { create :anime, :ongoing, name: '2', aired_on: 1.day.ago }
  ...
  let!(:anime6) { create :anime, :anons, name: '6', aired_on: 1.day.from_now }
  let!(:anime7) { create :anime, :anons, name: '7', aired_on: 2.days.from_now }
  let!(:anime8) { create :anime, :anons, name: '8', aired_on: 2.days.from_now }
