describe Api::V1::CommentsController do
  ...
  describe '#create' do
    ...
    context 'success', :show_in_doc do
      before { post :create, comment: { commentable_id: topic.id, commentable_type: topic.class.name, body: 'test', is_offtopic: false, review: false }, format: :json }
    ...
    context 'failure' do
      before { post :create, comment: { body: 'test', is_offtopic: false, review: false }, format: :json }
