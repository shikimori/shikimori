...
describe UserPreferencesController do
  ...
  describe :update do
    ...
    context 'preference change' do
      before { put :update, id: user.to_param, page: :profile, user_preferences: { body_background: 'test2' } }
    ...
    context 'about change' do
      before { put :update, id: user.to_param, page: :profile, user_preferences: { body_background: 'test2' }, user: { about: 'zxc' } }
