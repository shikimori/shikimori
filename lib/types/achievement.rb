module Types
  module Achievement
    ...
    NEKO_IDS = {
      ...
      NekoGroup[:author] => %i[
        makoto_shinkai hayao_miyazaki gen_urobuchi clamp satoshi_kon mamoru_oshii leiji_matsumoto masaaki_yuasa nobuyuki_fukumoto naoki_urasawa rumiko_takahashi go_nagai osamu_tezuka yoshiyuki_tomino ryousuke_takahashi yoshiaki_kawajiri shinji_aramaki osamu_dezaki isao_takahata yoshitaka_amano shinichiro_watanabe katsuhiro_otomo rintaro kouji_morimoto key hideaki_anno hiroyuki_imaishi type_moon mamoru_hosoda kouichi_mashimo masami_kurumada kenji_kamiyama tensai_okamura hiroshi_motomiya shoutarou_ishinomori mitsuteru_yokoyama shoji_kawamori masamune_shirow kenji_nakamura kunihiko_ikuhara kunihiko_yuyama osamu_kobayashi nobuo_uematsu yoshikazu_yasuhiko satoshi_dezaki tomoharu_katsumata
      ]
